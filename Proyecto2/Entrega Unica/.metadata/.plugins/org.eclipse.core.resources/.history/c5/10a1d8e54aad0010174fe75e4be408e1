...
public class ReporteFinanciero {
    ...
    public String toString() {
        ...
        if (gananciasxEvento == null || gananciasxEvento.isEmpty()) {
            sb.append(" - No hay registros de eventos con ganancias.\n");
        } else {
            for (Map.Entry<Evento, Double> e : gananciasxEvento.entrySet()) {
                sb.append(" - ").append(e.getKey().getNombre())
                  .append(": $").append(e.getValue()).append("\n");
            }
        }

        sb.append("\nGanancias por organizador:\n");
        if (gananciasxOrganizador == null || gananciasxOrganizador.isEmpty()) {
            sb.append(" - No hay registros de organizadores con ganancias.\n");
        } else {
            for (Map.Entry<Organizador, Double> o : gananciasxOrganizador.entrySet()) {
                sb.append(" - ").append(o.getKey().getNombre())
                  .append(": $").append(o.getValue()).append("\n");
            }
        }
